...
export default function PropertyCard({ property, onDoubleClick }) {
  ...
  const { addToCart, playSound, vibrateDevice } = useDragDropCart();
  ...
  return (
    <>
      ...
      >
        <Card 
          className="group transition-all duration-500 border-0 shadow-lg overflow-hidden hover:shadow-2xl hover:-translate-y-2"
          ...
          <CardContent className="p-6">
            ...
            <div className="flex gap-2">
              <Button 
                ...
                className="flex-1 bg-gradient-to-l from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 transition-all duration-300 hover:shadow-lg"
              >
                {property.status === 'در_حال_فروش' ? 'افزودن به سبد' : 'مشاهده جزئیات'}
              </Button>
